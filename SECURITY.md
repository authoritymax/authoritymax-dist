...
Email **security@authoritymax.ai** only. Do not open public GitHub issues for security bugs.
...
- General support: **support@authoritymax.ai**

## Scope

This policy covers the AuthorityMax self-hosted product in **this repository**.
